...
public class CorsGatewayConfiguration {
    ...
    public CorsWebFilter corsWebFilter() {
        ...
        // ✅ AJOUT : Accès spécifique pour l'IP 192.168.123.175
        corsConfig.addAllowedOrigin("http://192.168.123.175");
        corsConfig.addAllowedOrigin("https://192.168.123.175");
        corsConfig.addAllowedOriginPattern("http://192.168.123.175:*");
        corsConfig.addAllowedOriginPattern("https://192.168.123.175:*");
        
        // ✅ AJOUT : Accès spécifique pour l'IP 192.168.1.4
        corsConfig.addAllowedOrigin("http://192.168.1.4");
        corsConfig.addAllowedOrigin("https://192.168.1.4");
        corsConfig.addAllowedOriginPattern("http://192.168.1.4:*");
        corsConfig.addAllowedOriginPattern("https://192.168.1.4:*");
        
        // ✅ Credentials autorisés
       // corsConfig.setAllowCredentials(true);
corsConfig.setAllowCredentials(false); //conteneur docker
        // ✅ Headers autorisés
    ...
    public WebFilter corsWebFilter2() {
        return (ServerWebExchange ctx, WebFilterChain chain) -> {
            ...
            boolean isAllowedOrigin = origin != null && (
                ...
                // ✅ AJOUT : Vérification explicite pour 192.168.123.175
                origin.equals("http://192.168.123.175") ||
                origin.equals("https://192.168.123.175") ||
                origin.startsWith("http://192.168.123.175:") ||
                origin.startsWith("https://192.168.123.175:") ||
                // ✅ AJOUT : Vérification explicite pour 192.168.1.4
                origin.equals("http://192.168.1.4") ||
                origin.equals("https://192.168.1.4") ||
                origin.startsWith("http://192.168.1.4:") ||
                origin.startsWith("https://192.168.1.4:")
            );
