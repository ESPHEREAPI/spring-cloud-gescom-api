...
@NamedQueries({
    ...
    @NamedQuery(name = "Employeur.findById", query = "SELECT e FROM Employeur e WHERE e.id = :id"),
    //@NamedQuery(name = "Employeur.findByCheminLogo1", query = "SELECT e FROM Employeur e WHERE e.cheminLogo1 = :cheminLogo1")
})
