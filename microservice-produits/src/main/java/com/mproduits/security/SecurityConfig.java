...
public class SecurityConfig {
    ...
    // Mots de passe des comptes clients e-commerce (voir EcomAuthController,
    // Client.passwordHash) - jamais utilise pour Personne (microservice-
    // administration gere ses propres hashs staff independamment).
    @Bean
