...
@NamedQueries({
    ...
    @NamedQuery(name = "Entreprise.findByDateFinLicense", query = "SELECT e FROM Entreprise e WHERE e.dateFinLicense = :dateFinLicense"), //@NamedQuery(name = "Entreprise.findByAnneeId1", query = "SELECT e FROM Entreprise e WHERE e.anneeId1 = :anneeId1"),
...
public class Entreprise implements Serializable {
    ...
    public void setPrixarticlesCollection(Collection<PrixArticles> prixarticlesCollection) {
        this.prixarticlesCollection = prixarticlesCollection;
    }
    ...
    public Collection<Verrouillage> getVerrouillageCollection() {
        return verrouillageCollection;
    }

    public void setVerrouillageCollection(Collection<Verrouillage> verrouillageCollection) {
        this.verrouillageCollection = verrouillageCollection;
    }
